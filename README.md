...
| `obstacles_height_mm` | flaot | Optional | `z` | Height of the obstacles returned by the algoorithm. It can be any arbitrary value since the detector operates in a plane. |
