# Obstacle Detection from Planar Lidar
...
Use this module with a [RPlidar](https://app.viam.com/module/viam/rplidar) camera scanning for obstacles.
Follow [these instructions](https://github.com/viamrobotics/rplidar) to configure a RPlidar.
...
The following attributes are available for `obstacles_2d_lidar` 2D obstacles detection vision services:
...
### Example configuration (with RPlidar)
